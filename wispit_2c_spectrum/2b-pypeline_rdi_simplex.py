...
from scripts.simplex_AJB import SimplexMinimizationModule_rdi
...
module_simplex = SimplexMinimizationModule_rdi(position=position,
                                   magnitude=7.5,
...
module_simplex_write = FitsWritingModule(name_in='write_simplex',
                            data_tag=f'simplex_rdi',
                            file_name=f'simplex_rdi.fits',
                            output_dir=None,
                            data_range=None,
                            overwrite=True)
